            ...
            <form class="form">
              ...
              <div class="credit-card-info--form">
                <div class="input_container">
                    ...
                    <input id="nama" class="input_field" type="text" name="nama" title="Inpit title" placeholder="Masukkan Namamu">
                  </div>
                <div class="input_container">
                  <label for="email" class="input_label">Email</label>
                  <input id="email" class="input_field" type="text" name="email" title="Inpit title" placeholder="Masukkan Email">
                </div>
                <div class="input_container">
                ...
                <div class="input_container">
                  ...
                  <input id="telepon" class="input_field" type="number" name="telepon" title="Inpit title" placeholder="+ 62">
                </div>
                <div class="input_container">
                    <label for="ttl" class="input_label">Tanggal Lahir</label>
                    <input id="ttl" class="input_field" type="date" name="ttl" title="Inpit title" placeholder="0000 0000 0000 0000">
                  </div>
